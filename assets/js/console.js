        ...
        return new Promise((resolve, reject) => {
            switch(cmd.toLowerCase()) {
                case "":
                    ...
                    break;
                case "help":
					resolve(["-> help: well u js used so obv yk what this does", "-> stats: stats for nerds- i mean sillydstat.us", "-> mariam: tells you about my friend mariam", "-> clear: tf do u think?", "-> rank bypassed: shows biggest bypassed attacks", "-> rank raw: shows biggest raw attacks"]);
                    break;
                case "nload":
                    nload();
                    reject();
                ...
                case "qu":
                    ...
                    break;
                case "mariam":
                    resolve(["mariam is such an L bomber she cant even say 'Allah Akhbar' correctly and she hasnt blown any buildings up"]);
                    break;
                case "rank bypassed":
